...
function onError() {
  console.log('Failed to execute: $0')
  console.log('');
}
...
console.log(`BUILD_SCM_HASH ${_exec(`git rev-parse HEAD`)}`);
...
const BUILD_SCM_VERSION_RAW = _exec(`git describe --match [0-9].[0-9].[0-9]* --abbrev=7 --tags HEAD`);
